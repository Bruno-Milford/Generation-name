          ...
          <div class="card">
            <div class="card-body">
                ...
                <li class="list-group-item" v-for="prefix in prefixes" :key="prefix">
                  <div class="row">
                    ...
                    <div class="col-md text-right">
                      <button class="btn btn-danger" @click="deletePrefix(prefix)"><span class="fa fa-trash"></span></button>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <div class="input-group">
                ...
                v-model="prefix" @keyup.enter="addPrefix(prefix)" />
          ...
          <div class="card">
            <div class="card-body">
              <ul class="list-group">
                <li class="list-group-item" v-for="sufix in sufixes" :key="sufix">
                  <div class="row">
                    ...
                    <div class="col-md text-right">
                      <button class="btn btn-danger" @click="deleteSufix(sufix)"><span class="fa fa-trash"></span></button>
                    </div>
                  </div>
                </li>
              </ul>
              ...
              <div class="input-group">
                ...
                v-model="sufix" @keyup.enter="addSufix(sufix)" />
                <div class="input-group-append">
